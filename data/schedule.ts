...
export const SCHEDULE: ScheduleEvent[] = [
  ...
  },
  {
    ...
    timeSection: 'EVENING',
    details: [
      { icon: '📍', text: 'The Sphere at The Venetian. Arrive by 6:30 PM. No large bags.' },
      { icon: '⚡', text: 'Largest LED screen on earth. Sensory experience unlike anything.' },
      { icon: '👗', text: 'Smart casual. Dress for Nick\'s birthday — this is the moment.' },
    ],
  },
  {
    id: 'sat-4',
